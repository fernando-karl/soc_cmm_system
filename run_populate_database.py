#!/usr/bin/env python3
"""
Script para executar o SQL de população da base de dados do SOC CMM Assessment System
"""
...
def populate_database():
    ...
    sql_file = 'complete_populate_database.sql'
        ...
        for i, command in enumerate(commands, 1):
            if command:
                try:
                    ...
                    if i % 100 == 0:  # Mostrar progresso a cada 100 comandos
